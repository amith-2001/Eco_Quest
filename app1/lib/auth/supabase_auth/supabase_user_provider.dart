...
class App1SupabaseUser extends BaseAuthUser {
  App1SupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> app1SupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = App1SupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
