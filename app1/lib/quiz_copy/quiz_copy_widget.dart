                    ...
                    children: [
                      Padding(
                        padding: const EdgeInsetsDirectional.fromSTEB(
                            16.0, 100.0, 0.0, 0.0),
                        child: Text(
                          'When it comes to getting around, what\'s your go-to mode of transportation?',
                                ...
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: FlutterFlowCheckboxGroup(
                                      options: const [
                                        'I\'m a car person through and through!',
                                        'I prefer the ease of public transport. ',
                                        'Walking is how I roll.',
                                        'Biking is my jam! ',
                                        ' mix it up depending on the day! ('
                                      ],
                ...
                children: [
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        context.pushNamed('quizCopyCopyCopy');
                      },
                      text: 'Next Question',
