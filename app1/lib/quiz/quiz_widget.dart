                    ...
                    children: [
                      Padding(
                        padding: const EdgeInsetsDirectional.fromSTEB(
                            16.0, 100.0, 0.0, 0.0),
                        child: Text(
                          'Let\'s talk about food! What does your typical diet look like?',
                              ...
                              children: [
                                Expanded(
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        0.0, 12.0, 0.0, 12.0),
                                    child: FutureBuilder<List<SustainAppRow>>(
                                      future: SustainAppTable().queryRows(
                                        queryFn: (q) => q,
                                      ),
                                      builder: (context, snapshot) {
                                        ...
                                        List<SustainAppRow>
                                            checkboxGroupSustainAppRowList =
                                            snapshot.data!;
                                        return FlutterFlowCheckboxGroup(
                                          options: const [
                                            'Meat-lover! ',
                                            ' I\'m all about that plant-powered life! ',
                                            ' I usually mix it up ',
                                            'I avoid animal products, but still consume dairy or eggs.'
                                          ],
